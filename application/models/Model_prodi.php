...
class Model_prodi extends CI_Model {
    var $table = 'prodi';
    var $column_order = array(null, 'nama_fakultas', 'nama_prodi', 'status_prodi', null);
    var $column_search = array('nama_prodi', 'status_prodi', 'nama_fakultas');
    var $order = array('id_prodi' => 'desc');
    ...
    public function delete_by_id($id_prodi) {
        $this->db->where('id_prodi', $id_prodi);
